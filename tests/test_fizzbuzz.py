...
fb_1_to_100 = ['1', '2', 'fizz', '4', 'buzz', 'fizz', '7', '8', 'fizz', 'buzz', '11', 'fizz', '13', '14', 'fizzbuzz',
...
async def main():
    fb = aiofizzbuzz.AioFizzBuzz(1, 101)
    fb_list = [i async for i in fb]

    assert fb_list == fb_1_to_100
